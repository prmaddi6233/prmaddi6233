...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=3000&pause=1000&color=FF9900&center=true&vCenter=true&repeat=true&width=500&lines=Platform+Engineer+%C2%B7+AWS+%C2%B7+FinOps;150%2B+accounts+%7C+Evidence-based+optimization;Kubernetes+%C2%B7+Terraform+%C2%B7+Cost+Governance)](https://git.io/typing-svg)
...
focus:
  - Platform Engineering (150+ AWS accounts)
  - FinOps & Cost Governance
  - Kubernetes at Scale (EKS)
  - Infrastructure Automation
current_project: cloud-finops-agent (open source)
thesis: >
  Cost recommendations rot in backlogs because
  nobody proves they're safe. I build the evidence
  layer that does.
```

> 🔥 **Currently building** [cloud-finops-agent](https://github.com/prmaddi6233/cloud-finops-agent) — tiered FinOps validation with production canaries, SARIF findings, and fail-closed safety.
...
| Policy engines over runbooks | SCPs and Kyverno enforce — docs get forgotten |
| Fail closed or it's not safety | If the system can't verify, it stops |
...
[![CKA](https://img.shields.io/badge/CKA-Certified%20Kubernetes%20Administrator-326CE5?style=for-the-badge&logo=kubernetes&logoColor=white)](https://www.credly.com/badges/5150b9c4-aa9b-4946-8fc0-c2c2fa3bfbb9/linked_in_profile)
[![FinOps](https://img.shields.io/badge/FinOps-Certified%20Engineer-4B0082?style=for-the-badge)](https://verify.skilljar.com/c/kaqtuub8ax3j)
[![AWS](https://img.shields.io/badge/AWS-Solutions%20Architect%20Associate-FF9900?style=for-the-badge&logo=amazonwebservices&logoColor=white)](https://www.credly.com/badges/5150b9c4-aa9b-4946-8fc0-c2c2fa3bfbb9/linked_in_profile)
...
![Kyverno](https://img.shields.io/badge/Kyverno-FD5A3B?style=flat-square)
![OpenCost](https://img.shields.io/badge/OpenCost-326CE5?style=flat-square)
...
![Spacelift](https://img.shields.io/badge/Spacelift-2C2C32?style=flat-square)
![Terragrunt](https://img.shields.io/badge/Terragrunt-4B0082?style=flat-square)
...
![GuardDuty](https://img.shields.io/badge/GuardDuty-DD344C?style=flat-square)
![SecurityHub](https://img.shields.io/badge/Security%20Hub-DD344C?style=flat-square)
![AWS Config](https://img.shields.io/badge/AWS%20Config-FF4F8B?style=flat-square)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/pradeep-maddi)
